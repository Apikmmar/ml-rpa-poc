...
async def create_stock_transfer(from_location: str, to_location: str, from_rack: str, to_rack: str, sku: str, quantity: int, requested_by: str):
    async with httpx.AsyncClient() as client:
        ...
        payload = {"fields": {"from_location": from_location, "to_location": to_location, "from_rack": from_rack, "to_rack": to_rack, "sku": sku, "quantity": quantity, "status": "Pending", "requested_by": requested_by, "created_at": now, "created_by": requested_by, "updated_at": now, "updated_by": requested_by}}

...
# CreateLowStockAlert + BackorderFulfillmentChecker → 1 Lambda: StockChangeHandler
# Both trigger on Stocks MODIFY. Just check both conditions in one handler:

# stock_pct ≤ 50 → low stock alert

# stock_pct > 50 → check pending backorders